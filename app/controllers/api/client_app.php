...
switch ($_SERVER['REQUEST_METHOD']) {
    case 'POST':
        if (!isset($_POST['url'], $_POST['name'], $_POST['redirect_url'], $_POST['data'])) {
            Controller::http400BadRequest();
            Controller::renderApiError('You must provide url, name, redirect_url and data set');
        }
        ...
        $logo = empty($_POST['logo']) || $_POST['logo'] === 'undefined' ? 'https://static.justauth.me/medias/default_logo.png' : $_POST['logo'];
