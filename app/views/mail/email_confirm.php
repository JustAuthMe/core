...
<tr>
    <td height="30" align="center">
        <h1 style="text-transform: uppercase;font-size: 24px;">E-Mail address confirmation</h1>
    </td>
</tr>
<tr>
    <td>
    ...
    <td align="center">
        <a href="<?= $confirm_link ?>" style="color:white;text-decoration:none;">
            <table width="200" bgcolor="#3598db" style="border-radius:20px">
                <tr color="white">
                    <td height="25" align="center" style="font-size: 11px;text-transform: uppercase; color: white;" color="white">Confirm my E-Mail Address</td>
                </tr>
            </table>
        </a>
    </td>
