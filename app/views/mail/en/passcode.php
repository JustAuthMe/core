                            ...
                            <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"
                                ...
                                <div>
                                    <h4 class=""
                                        ...
                                        align="left">Confirmation code</h4>
                                    ...
                                    <p class=""
                                       ...
                                       align="left">
                                        Hello,<br />
                                        You recently wished to login to your JustAuthMe account on your smartphone.
                                        In order to complete the login process, we invite you to enter the code below
                                        into the app.
                                        This code is only valid for 10 minutes.
                                        If the code does not display or if you encounters issues while using it,
                                        please contact support to this e-mail: <a href="mailto:support@justauth.me">support@justauth.me</a>
                                        <br /><br />
                                        ATTENTION: This code is <strong>strictly personal</strong> and must not be disclosed to anyone.
                                        No employee of JustAuthMe will ever ask you about this code. If you currently are in touch with
                                        someone who pretends to work for JustAuthMe and wants you to give them this code,
                                        <strong>please don't do it</strong>, it's a scam!
                                    </p>
                                    <table  border="0" cellpadding="0"
                                            cellspacing="0" style="width: 100%;">
                                        <tbody>
                    ...
                    <table class="card-body" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%;">
                        ...
                        <tr>
                            <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                <div>
                                    <h4 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 24px; line-height: 28.8px;" align="center">Confirmation code</h4>
                                    <h1 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 36px; line-height: 43.2px;" align="center"><?= $passcode ?></h1>
                                </div>
                            </td>
                        </tr>
                        </tbody>
